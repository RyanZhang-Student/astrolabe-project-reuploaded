...
def generate_and_append_analysis_4(html_file_path):
    ...
    try:
        ...
        prompt_intro = """
        你是一个专业的占星师。请仔细阅读以下占星报告 HTML 代码中的数据表格，提取关于**第4宫的所有相关信息。
        
        请严格按照以下模板的格式和分点结构，为我生成第4宫的深度分析报告 .
        ...
        <details style="max-width: 800px; margin: 40px auto; padding: 20px; background-color: #f8f9fa; border-left: 5px solid #4B0082; border-radius: 8px;">
            <summary style="cursor: pointer; font-weight: bold;">
                <h2 style="color: #333; display: inline;">🔮 深度分析：第4宫</h2>
            </summary>
