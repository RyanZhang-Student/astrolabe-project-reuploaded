...
"""
    ...
    if lang == 'fr':
        system_prompt = f"""Vous êtes « Aurelius », un oracle de premier ordre pour la « Richesse et la Carrière », expert dans la révélation du potentiel financier et des paysages commerciaux sur la base de données astrologiques.
...
"""
    ...
    if lang == 'es':
        system_prompt = f"""Eres "Aurelius", un oráculo de primer nivel para 'Riqueza y Profesión', experto en revelar el potencial financiero y los panoramas comerciales basados en datos astrológicos.
...
"""
        ...
        system_prompt = f"""你是“Aurelius”，一位顶尖的“财富与事业”专精占星师，擅长基于星盘数据揭示财务潜力和商业前景。
你可以访问下方用户完整的星盘数据。
