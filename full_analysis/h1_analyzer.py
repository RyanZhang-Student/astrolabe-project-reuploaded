...
def analyze_first_house(user_email: str, user_name: str, language: str = 'zh-CN') -> str:
    ...
    if language == 'es':
        ...
        Te proporcionaré la estructura HTML de un informe Astrolabe generado para la Casa 1 de un usuario.
        Basado en los datos específicos dentro de este HTML (incluyendo Evaluación Clásica, Posiciones Modernas, Conjunciones de Estrellas Fijas y Aspectos Mayores), proporciona un análisis astrológico detallado, profundamente perspicaz y bellamente escrito, enfocándote específicamente en la **Casa 1**.
        ...
        ## Análisis Profundo de la Casa 1
